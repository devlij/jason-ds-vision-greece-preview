...
- **GR-01-001 through GR-01-224**, with no gaps.
- Each scene has a 1920×1080 master and an 864×1080 master under `library/world/Greece/<City>/`.
- Latest scenario label: 24 September 2026 · 09:35 Europe/Athens (surplus fill, GR-01-209 through GR-01-224).
- Weather for that batch is Open-Meteo model data retrieved 2026-09-24T06:27Z, valid 2026-09-24T09:15 Europe/Athens. The scenario label is the build time, 09:35 Europe/Athens. It is not a verified on-site observation.
